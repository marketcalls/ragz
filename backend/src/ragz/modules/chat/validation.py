...
from ragz.modules.chat.prompting import PromptSource, render_data_blocks, wrap_untrusted_block
from ragz.modules.models.models import Model  # type only; resolution stays in models service
...
AUDITOR_SYSTEM_PROMPT = (
    "You are Ragz's Auditor, an automated answer-quality judge. You will be "
...
GATEKEEPER_SYSTEM_PROMPT = (
    "You are Ragz's Gatekeeper, a pre-publication answer reviewer. You will "
...
ESCALATION_CLASSIFIER_PROMPT = (
    "You are Ragz's escalation classifier. Decide whether the user's "
